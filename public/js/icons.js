// icons.js — feather-style inline SVG icons
const ICON = (path, attrs = '') =>
  `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" ${attrs}>${path}</svg>`;
...
export const icons = {
  ...
  trash:       ICON('<polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6M14 11v6"/><path d="M9 6V4a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2"/>'),
  chevRight:   ICON('<polyline points="9 18 15 12 9 6"/>'),
  chevDown:    ICON('<polyline points="6 9 12 15 18 9"/>'),
  chevLeft:    ICON('<polyline points="15 18 9 12 15 6"/>'),
  ...
  fileText:    ICON('<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="13" x2="15" y2="13"/><line x1="9" y1="17" x2="13" y2="17"/>'),
  play:        ICON('<polygon points="5 3 19 12 5 21 5 3"/>'),
  pause:       ICON('<rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/>'),
  rewind:      ICON('<polygon points="11 19 2 12 11 5 11 19"/><polygon points="22 19 13 12 22 5 22 19"/>'),
...
export const renderIcon = (name, attrs = '') => icons[name] || '';
